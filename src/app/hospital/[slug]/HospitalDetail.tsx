...
const STR: Record<ToggleLocale, UI> = {
  ...
  vi: { back: "Danh sách bệnh viện đối tác", strengths: "Thế mạnh", signature: "Thủ thuật tiêu biểu", prices: "Danh mục · Giá thủ thuật", priceAll: "Tất cả", priceSame: "Cùng giá với người Hàn · Không phụ phí người nước ngoài", priceDisclaim: "Giá hiển thị đã bao gồm VAT và được xác định cuối cùng sau khi tư vấn theo tình trạng cá nhân.", priceEmpty: "Danh mục·giá thủ thuật đang được cập nhật.", exclusiveBadge: "Đối tác độc quyền", exclusive: " là đối tác marketing độc quyền của Time of Passion. Việc liên hệ trực tiếp với bệnh viện có thể gây vấn đề pháp lý; mọi tư vấn·đặt hẹn phải được thực hiện thông qua Time of Passion.", doctors: "Đội ngũ bác sĩ", interior: "Không gian", beforeAfter: "Trước & Sau", before: "TRƯỚC", after: "SAU", baEmpty: "Ảnh trước & sau đang được chuẩn bị.", mohw: "Doanh nghiệp marketing thu hút bệnh nhân nước ngoài đã đăng ký với Bộ Y tế Hàn Quốc", heading: "Tư vấn miễn phí với Time of Passion", name: "Họ tên", contactType: "Phương thức liên hệ", contact: "Thông tin liên hệ", message: "Nội dung", submit: "Gửi yêu cầu", sending: "Đang gửi…", success: "Đã tiếp nhận. Chúng tôi sẽ liên hệ sớm.", consent: "Tôi đồng ý cho thu thập và sử dụng thông tin cá nhân." },
}
