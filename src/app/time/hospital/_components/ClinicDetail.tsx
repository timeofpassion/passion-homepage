    ...
    <>
      <header className="mt-head">
        <div className="hd-in">
          ...
          <Link href={`/time/hospital/${lang}`} className="back" aria-label="목록으로">
            ←
          </Link>
        </div>
      </header>
      ...
      <div className="wrap">
        ...
        <div className="d-hero">
          ...
          <div className="hero-tag">
            {CATEGORY_LABEL[clinic.category]} · {clinic.location.areaHint.replace("서울 강남 · ", "")}
          </div>
        </div>
        ...
        <section>
          ...
          <div className="loc-card">
            ...
            <div className="muted">
              정확한 위치는 컨시어지 예약 확정 시 안내되며, 통역 매니저가 현장에서
              동행합니다.
            </div>
          </div>
        </section>
