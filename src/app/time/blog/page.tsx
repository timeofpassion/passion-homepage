...
export const metadata: Metadata = {
  ...
  description:
    "병원 마케팅 전문 에이전시 열정의시간의 마케팅 인사이트. 일본 라인 마케팅, 중국 샤오홍슈, 대만 멀티채널 등 10년 이상 현장에서 검증한 해외환자 유치 전략을 정리합니다.",
  keywords: [
    "병원마케팅",
    "해외환자유치",
    "일본마케팅",
  ...
  openGraph: {
    ...
    description:
      "일본·중국·대만 해외환자 유치 전략을 10년 이상 현장 관점에서 정리한 열정의시간 마케팅 인사이트.",
      ...
      <main className="relative z-10">
        ...
        <section style={{ padding: "8rem 0 1.5rem" }}>
          <div style={{ maxWidth: 1180, margin: "0 auto", padding: "0 6%" }}>
            ...
            >
              일본 라인 마케팅, 중국 샤오홍슈, 대만 멀티채널까지. 10년 이상 현장에서
